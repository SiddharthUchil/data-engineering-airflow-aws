...
weather_dyf = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": ["s3://airflowoutputtos3buckets/raw/weather_api_data.csv"],
        "recurse": True,
    },
...
redshift_output = glueContext.write_dynamic_frame.from_options(
    ...
    connection_options={
        "redshiftTmpDir": "s3://aws-glue-assets-262136919152-us-east-1/temporary/",
        "useConnectionProperties": "true",
        "aws_iam_role": "arn:aws:iam::771807539004:role/dataproject-RedshiftIamRole-A2eQR04N12wh",
