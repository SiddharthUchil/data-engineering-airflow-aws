...
transform_task = GlueJobOperator(
    ...
    script_location='s3://aws-glue-assets-262136919152-us-east-1/scripts/transform.py',
    s3_bucket='s3://aws-glue-assets-262136919152-us-east-1',  # S3 bucket where logs and local etl script will be uploaded
    aws_conn_id='AWS_CONN',  # You'll need to set up an AWS connection in Airflow
    region_name="us-east-1",
    iam_role_name='dataproject-RedshiftIamRole-A2eQR04N12wh',
